...
The duhh-mov browser extension enhances streaming quality and makes it possible to scrape more sources.
...
These installation steps are for any chromium-based browsers such as Google Chrome, Microsoft Edge, Vivaldi, Brave, Arc or Opera/Opera GX.

### Loading a CRX file

<Steps>
  <Steps.Step>
    Download the CRX file [here](https://github.com/passtheweed/docs/raw/refs/heads/master/Duhh-Mov%20Ext-CHROME.crx).
    <Warning>
...
<Steps>
  <Steps.Step>
    Download and **unpack** the ZIP file from [here](https://github.com/passtheweed/mov/raw/refs/heads/main/Duhh-Mov%20Ext-CHROME.zip).
  </Steps.Step>
...
<Steps>
  ...
  <Steps.Step>
    Download the XPI file from [here](https://github.com/passtheweed/mov/raw/refs/heads/main/Duhh-Mov%20Ext-FIREFOX.xpi). It should automatically start the installation process.
  </Steps.Step>
